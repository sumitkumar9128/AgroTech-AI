  ...
  return (
    <div className="max-w-full mt-16 mx-auto px-4 pb-10 pt-5 sm:px-6 lg:px-8">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-green-500 dark:text-green-400">🍀AI Engine🍀</h1>
        <p className="text-xl text-gray-700 dark:text-gray-300 mt-2">Let AI Engine Help You To Detect Disease</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          <h5 className="font-bold text-xl mb-4 text-gray-900 dark:text-gray-100">Why is it necessary to detect disease in plants?</h5>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="flex items-center justify-center">
              ...
              <input
                ...
                accept="image/*"
              />
              <span className="ml-3 text-gray-700 dark:text-gray-300">{fileName}</span>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          <h5 className="font-bold text-xl mb-4 text-gray-900 dark:text-gray-100">Prevent Plant Disease by following these steps:</h5>
