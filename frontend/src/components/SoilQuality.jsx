                    ...
                    <div className="max-w-lg mx-auto mt-10 text-center p-5 border-2  text-green-900 border-green-500 shadow-2xl shadow-green-200 rounded-md">
                        ...
                        <form method="post" acceptCharset="utf-8" name="Modelform" className="grid grid-cols-2 gap-4" style={{ backgroundImage: `url(${bgHero})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Nitrogen</label>
                                <input
                                    type="text"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Phosphorus</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="P"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Potassium</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="K"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">pH Level</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="pH"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Electrical Conductivity</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="EC"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Organic Carbon</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="OC"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Sulphur</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="S"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Zinc</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="Zn"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Iron</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="Fe"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Copper</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="Cu"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Manganese</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="Mn"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Boron</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="B"
