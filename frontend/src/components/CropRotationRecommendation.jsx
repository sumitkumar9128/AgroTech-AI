                    ...
                    <div className="max-w-lg mx-auto mt-10 text-center p-5 border-2 text-green-900 border-green-500 shadow-2xl shadow-green-200 rounded-md">
                        ...
                        <form className="grid grid-cols-2 gap-4" method="post" acceptCharset="utf-8" name="Modelform">
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Previous Crop</label>
                                <input
                                    type="text"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Soil Type</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="soilType"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Moisture Level</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="moistureLevel"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Nitrogen (N)</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="N"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Phosphorus (P)</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="P"
                            ...
                            <div className="flex justify-between items-center">
                                <label className="block text-left ml-2 text-black dark:text-white font-semibold w-1/3">Potassium (K)</label>
                                <input
                                    type="text"
                                    className="w-1/2 px-3 py-2 border border-green-500 rounded"
                                    id="K"
